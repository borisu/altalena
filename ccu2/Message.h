...
#define NULL_MSG IwMessagePtr((IwMessage*)NULL)
	...
	{
	public:
		CcuMsgResponse(int message_id, const string message_id_str):
		  IwMessage (message_id, message_id_str)
		  {
			  is_response = TRUE;
		  }
...
#pragma region Simpletons
	...
	public:
		CcuMsgAck():
		CcuMsgResponse(MSG_ACK, NAME(MSG_ACK)){};
	};
	...
	public:
		CcuMsgNack():
		  CcuMsgResponse(MSG_NACK, NAME(MSG_NACK)){};
	};
...
#pragma region Process_Management_Events
	...
	public:
		CcuMsgPong():
		  CcuMsgResponse(MSG_PONG, NAME(MSG_PONG)){};
	};
	...
	public:
		CcuMsgShutdownAck():
		  CcuMsgResponse(MSG_PROC_SHUTDOWN_ACK, NAME(MSG_PROC_SHUTDOWN_ACK)){};
	};
