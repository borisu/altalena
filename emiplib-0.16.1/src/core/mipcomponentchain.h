...
public:
	...
	/** Process loop
	*  Added to support client thread model
	*/
...
public:
	...
	bool m_clientThread;
	bool ClientThread() const { return m_clientThread; }
	void ClientThread(bool val) { m_clientThread = val;}

	bool m_exitOnEmptyChain;
	bool ExitOnEmptyChain() const { return m_exitOnEmptyChain; }
	void ExitOnEmptyChain(bool val) { m_exitOnEmptyChain = val; }
